...
public class DemoPersonnel extends UnDeleteBaseModel {

	public final static String COLUMN_FIELD_IDENTIFICATIONNO = "identificationNo";
	public final static String COLUMN_FIELD_SEX = "sex";
