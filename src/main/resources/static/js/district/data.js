...
_provinces.forEach(function (d) {
    _districtMap[d.id] = d;
})

_cities.forEach(function (d) {
    _districtMap[d.id] = d;
})

_districts.forEach(function (d) {
    _districtMap[d.id] = d;
})

function getDistrict(code) {
    return _districtMap[code];
}

function getDistrictFullName(code, separator) {
    var v = "";
    separator = separator || '-';
    var a = getDistrict(code);
    if (a) {
        v = a.name;
        if (a.pid != -1) {
            a = getDistrict(v.pid);
