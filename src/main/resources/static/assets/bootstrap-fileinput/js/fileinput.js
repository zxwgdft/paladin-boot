    ...
    FileInput.prototype = {
        ...
        _uploadSingle: function (i, isBatch) {
            ...
            fnSuccess = function (data, textStatus, jqXHR) {	
            	var resStatus = data.status, status = {
        	        NO_LOGIN: -1,
        	        NO_PERMISSION: -2,
        	        SUCCESS: 1,
        	        FAIL: 2,
