/*
 ...
 Source Server         : 172.16.16.120
 Source Server Type    : MySQL
 Source Server Version : 50727
 Source Host           : 172.16.16.120:3306
 Source Schema         : boot
...
CREATE TABLE `db_build_column`  (
  ...
  `connection_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `table_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `column_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `enum_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '常量CODE',
  `multi_select` tinyint(4) NULL DEFAULT NULL COMMENT '是否多选',
  `is_attachment` tinyint(4) NULL DEFAULT NULL COMMENT '是否附件',
  `attachment_count` int(11) NULL DEFAULT NULL COMMENT '附件数量',
  `required` tinyint(4) NULL DEFAULT NULL COMMENT '是否必填',
  `tableable` tinyint(4) NULL DEFAULT NULL COMMENT '是否列表显示',
  `editable` tinyint(4) NULL DEFAULT NULL COMMENT '是否可编辑',
  `addable` tinyint(4) NULL DEFAULT NULL COMMENT '是否新增',
  `large_text` tinyint(4) NULL DEFAULT NULL COMMENT '是否大文本',
  `max_length` int(11) NULL DEFAULT NULL COMMENT '最大长度',
  `regular_expression` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '正则验证表达式',
...
CREATE TABLE `db_build_table`  (
  ...
  `connection_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `table_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `table_title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `db_connection` VALUES ('db_boot', 'jdbc:mysql://172.16.16.120:3306/boot?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8', 'MYSQL', 'netin', '123456', '');
...
CREATE TABLE `org_permission`  (
  ...
  `url` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '表现形式1：URL2：CODE',
  ...
  `menu_icon` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '图标',
  `description` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '权限描述',
  ...
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '创建人',
...
-- ----------------------------
INSERT INTO `org_permission` VALUES ('1000', '系统管理', NULL, 'sys', 1, 0, NULL, NULL, NULL, 1, 0, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('1010', '角色管理', '', 'sys:role', 0, 0, '', NULL, '1000', 1, 997, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('1011', '角色管理', '/common/org/role/index', 'sys:role:index', 1, 1, '', NULL, '1010', 1, 1, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('1012', '新增角色', '', 'sys:role:save', 0, 0, NULL, NULL, '1010', 0, 3, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('1013', '修改角色', '', 'sys:role:update', 0, 0, NULL, NULL, '1010', 0, 4, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('1014', '权限授权', '', 'sys:role:grant', 0, 0, NULL, NULL, '1010', 0, 5, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('1110', '登录日志查看', '/common/sys/logger/login/index', 'sys:logger:login:index', 1, 1, NULL, NULL, '1000', 1, 998, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('1900', '容器管理', '/common/container/index', 'admin:container', 1, 1, NULL, NULL, '1000', 1, 999, 0, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2000', '组织管理', NULL, 'org', 1, 0, NULL, NULL, NULL, 0, 1, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2010', '人员管理', '', 'org:personnel', 0, 0, NULL, NULL, '2000', 0, 1, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2011', '人员管理', '/demo/org/personnel/index', 'org:personnel:index', 1, 1, NULL, NULL, '2010', 0, 1, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2013', '新增人员', '', 'org:personnel:save', 0, 0, NULL, NULL, '2010', 0, 3, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2014', '修改人员', '', 'org:personnel:update', 0, 0, NULL, NULL, '2010', 0, 4, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2015', '删除人员', '', 'org:personnel:delete', 0, 0, NULL, NULL, '2010', 0, 5, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2016', '导出人员', '', 'org:personnel:export', 0, 0, NULL, NULL, '2010', 0, 6, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2020', '机构管理', '', 'org:unit', 0, 0, NULL, NULL, '2000', 0, 2, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2021', '机构管理', '/demo/org/unit/index', 'org:unit:index', 1, 1, NULL, NULL, '2020', 0, 1, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2023', '新增单位', '', 'org:unit:save', 0, 0, NULL, NULL, '2020', 0, 3, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2024', '修改单位', '', 'org:unit:update', 0, 0, NULL, NULL, '2020', 0, 4, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
INSERT INTO `org_permission` VALUES ('2025', '删除单位', '', 'org:unit:delete', 0, 0, NULL, NULL, '2020', 0, 5, 1, '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', 'admin', b'0');
...
CREATE TABLE `org_personnel`  (
  ...
  `unit_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '所属机构',
  `identification_type` tinyint(4) NOT NULL COMMENT '证件类型',
  `identification_no` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '证件号码',
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `sex` tinyint(4) NULL DEFAULT NULL COMMENT '性别',
  `birthday` datetime(0) NULL DEFAULT NULL COMMENT '出生日期',
  `cellphone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号码',
  `office_phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '电话号码',
  `nation` smallint(6) NULL DEFAULT NULL COMMENT '民族',
  `resume` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '简历',
...
CREATE TABLE `org_role`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'id',
  `role_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '角色名称',
  `role_level` tinyint(4) NOT NULL COMMENT '角色等级（考核权限等级）',
  `role_desc` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '角色说明',
...
CREATE TABLE `org_role_permission`  (
  `role_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '角色ID',
  `permission_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '菜单ID',
...
CREATE TABLE `org_unit`  (
  ...
  `name` varchar(120) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '单位名称',
  `type` tinyint(4) NOT NULL COMMENT '单位类型',
  `parent_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上级单位',
...
-- Records of org_unit
-- ----------------------------
INSERT INTO `org_unit` VALUES ('1fT4-742peLu6zcRerRUUQ', '第一人民医院', 1, '', '张文', '13584950000', 1, '2020-03-09 10:34:47', 'ad313d38fe9447ce863fe8584743a010', '2020-03-09 10:34:47', 'ad313d38fe9447ce863fe8584743a010', b'0');
INSERT INTO `org_unit` VALUES ('6kf6Ds_Wp5wIVM_BFgoUKw', '外科', 2, '1fT4-742peLu6zcRerRUUQ', '刘医生', '13584950000', 10, '2020-03-09 10:52:51', 'ad313d38fe9447ce863fe8584743a010', '2020-03-09 11:12:34', 'ad313d38fe9447ce863fe8584743a010', b'0');
INSERT INTO `org_unit` VALUES ('7gGneX0jb792kBFCPcwPag', '疾控科', 2, 'kBu6Ud4RES25xcHAIxeCJQ', '武达', '13584950000', 1, '2020-03-09 11:14:19', 'ad313d38fe9447ce863fe8584743a010', '2020-03-09 11:14:19', 'ad313d38fe9447ce863fe8584743a010', b'0');
INSERT INTO `org_unit` VALUES ('cY2VL408mS_e6ua5tppHpA', '妇科', 2, '1fT4-742peLu6zcRerRUUQ', '吴医生', '13584950000', 2, '2020-03-09 10:53:25', 'ad313d38fe9447ce863fe8584743a010', '2020-03-09 10:53:25', 'ad313d38fe9447ce863fe8584743a010', b'0');
INSERT INTO `org_unit` VALUES ('kBu6Ud4RES25xcHAIxeCJQ', '卫健委', 1, '', '刘仁', '13584950000', 0, '2020-03-09 11:13:44', 'ad313d38fe9447ce863fe8584743a010', '2020-03-09 11:13:44', 'ad313d38fe9447ce863fe8584743a010', b'0');
INSERT INTO `org_unit` VALUES ('tS6TrjSyX3jKZ2zf_7rIKw', '第二人民医院', 1, '', '张三', '13584950000', 3, '2020-03-19 11:32:18', 'BrocI_IUOi8uvcVesEWEJQ', '2020-03-19 11:32:18', 'BrocI_IUOi8uvcVesEWEJQ', b'0');
...
CREATE TABLE `sys_attachment`  (
  ...
  `store_type` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `suffix` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `size` int(11) UNSIGNED NULL DEFAULT NULL,
  `relative_path` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `thumbnail_relative_path` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '缩略图相对地址',
...
-- ----------------------------
INSERT INTO `sys_attachment` VALUES ('3c3c24303ff2498f8056eb87e5679aee', 1, 'default', '老年人健身', '.jpg', 155024, '20200317/3c3c24303ff2498f8056eb87e5679aee.jpg', NULL, '2020-03-17 09:11:25', b'0', NULL);
INSERT INTO `sys_attachment` VALUES ('c2ea86c1b58242b29b927cfbd8cc3cd6', 1, 'default', '刚出生的柯基', '.jpg', 135791, '20200317/c2ea86c1b58242b29b927cfbd8cc3cd6.jpg', NULL, '2020-03-17 10:54:52', b'0', NULL);
INSERT INTO `sys_attachment` VALUES ('daf5b54e172e4401aaf4a6fc499fd297', 1, 'default', '年轻人不要熬夜', '.jpg', 403023, '20200317/daf5b54e172e4401aaf4a6fc499fd297.jpg', NULL, '2020-03-17 09:11:25', b'0', NULL);
INSERT INTO `sys_attachment` VALUES ('fb5be8fabe534018ae9b8ef16c20a615', 1, 'default', '英女皇与她的狗', '.jpeg', 69807, '20200317/fb5be8fabe534018ae9b8ef16c20a615.jpeg', NULL, '2020-03-17 09:11:22', b'0', NULL);
...
CREATE TABLE `sys_constant`  (
  ...
  `code` varchar(11) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '编码ID',
...
CREATE TABLE `sys_logger_operate`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `model_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模块名称',
  `operate_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '操作名称',
  `class_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '类名称',
  `method_name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '方法名称',
  ...
  `operate_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '操作人',
  `operate_by_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '操作人名称',
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '操作时间',
  `operate_duration` int(11) NULL DEFAULT NULL COMMENT '操作时长',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `sys_user`  (
  ...
  `is_first_login` tinyint(4) NULL DEFAULT 1 COMMENT '是否第一次登录',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('2qiIT_bFLUFStx8fCQFxIA', 'zhudan', '27b9681d1ff3fae11430e0e18d95d28b', '7e3bc62e32f2074e0be700f3d6df8149', 'BCjljSsd1bndH2wvMobB9w', 1, 1, 3, '2020-03-16 16:15:03', 'ad313d38fe9447ce863fe8584743a010', '2020-03-16 16:15:03', 'ad313d38fe9447ce863fe8584743a010', b'0', NULL);
INSERT INTO `sys_user` VALUES ('3TAcDcTNkAz-lvKIkVr3dg', 'liyuanmei_338688', '0c418e1e5a523f286870ebd00cf3af3f', 'c350df874a50c96b9522de31baac4222', '00060a6c25b94c3bb3c95cd8aa15bd64', 1, 1, 3, '2020-04-01 11:06:53', '', '2020-05-19 16:12:22', '', b'0', '2020-05-19 16:12:22');
INSERT INTO `sys_user` VALUES ('ad313d38fe9447ce863fe8584743a010', 'admin', '48379ee570aa6772e692623d826846ed', 'd3b04396a75024974c5c97787c17547a', '', 1, 1, 1, '2019-03-22 09:59:44', NULL, '2020-06-16 10:33:57', '', b'0', '2020-06-16 10:33:57');
INSERT INTO `sys_user` VALUES ('Hs0Lw4k2hIjy4vPFmkaQ5g', 'zhouxingxing', '439f8290319aa2174b82adcc2f836c66', '48d33e833a78e41d6bf791ae1ef23d9a', 'FrX7JyqZVB3W3u41wBtprw', 1, 1, 3, '2020-03-17 10:58:30', 'ad313d38fe9447ce863fe8584743a010', '2020-03-17 10:58:30', 'ad313d38fe9447ce863fe8584743a010', b'0', NULL);
INSERT INTO `sys_user` VALUES ('J309ecE_G7NUajMDb8tvQg', 'zhouxuwu', 'e22c088055a5ada418f9a52be6676535', '3baf18b030ea37785a0a112a9f180c9d', 'BrocI_IUOi8uvcVesEWEJQ', 1, 1, 3, '2020-03-17 09:11:26', 'ad313d38fe9447ce863fe8584743a010', '2020-07-01 10:50:32', '', b'0', '2020-07-01 10:50:32');
INSERT INTO `sys_user` VALUES ('KPG86iVnfC9BgkclJrQwog', 'zhangtianshuo', '3de12dfd672fdb29b5bf13c29f1fe559', '2e3e2610b5869649d0bf7ab16f7037bb', '7yqslBkAG-XCjFmtaH4-8Q', 1, 1, 3, '2020-03-17 10:56:27', 'ad313d38fe9447ce863fe8584743a010', '2020-03-17 10:56:27', 'ad313d38fe9447ce863fe8584743a010', b'0', NULL);
INSERT INTO `sys_user` VALUES ('OkWSUDWa_thVbDL-eDYzYg', 'kewen001', '0c9e74c7ddbb116a48d0a99b5b5fb0e2', 'acaa8e79947162432c5470b16f70d64b', 'WX14wsMFPCucbgiDLCLtFg', 1, 1, 3, '2020-03-17 10:57:24', 'ad313d38fe9447ce863fe8584743a010', '2020-03-19 11:31:31', '', b'0', '2020-03-19 11:31:31');
INSERT INTO `sys_user` VALUES ('qRZYwX0OwMzqvBliRecsVw', 'yangyang', '36d2cd433a38b266d1237056b3dcd49e', 'f52266837b88ce2ec40fc5c131c72af4', 'lHMmloreL_B1rXrDmul8Qw', 1, 1, 3, '2020-03-17 10:54:52', 'ad313d38fe9447ce863fe8584743a010', '2020-03-17 10:54:52', 'ad313d38fe9447ce863fe8584743a010', b'0', NULL);
INSERT INTO `sys_user` VALUES ('WP1GMTcLAiJ_BdnCCc5ifg', 'liuwenwen', 'ce83acc8df713d5f2cc4b424c1dd6f6f', '2b3f0338da5de3273f833579596b3ca2', 's0JE93DyHcP_Sp5IhAPffQ', 1, 1, 3, '2020-03-17 10:55:38', 'ad313d38fe9447ce863fe8584743a010', '2020-03-17 10:55:38', 'ad313d38fe9447ce863fe8584743a010', b'0', NULL);
INSERT INTO `sys_user` VALUES ('YLO0mxoBwCd8W5TJk2Zy6w', 'lisi001', '1b85c26f9f2f1ab3e6367f54175c69cb', '5ee440a018a7779b005d9e1ef5731577', 'zIpIlLzzpBaWYv2B6SgFCg', 1, 1, 3, '2020-03-19 11:33:11', 'BrocI_IUOi8uvcVesEWEJQ', '2020-03-19 11:33:11', 'BrocI_IUOi8uvcVesEWEJQ', b'0', NULL);
...
CREATE TABLE `sys_visit_cache`  (
  ...
  `code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'IP',
...
-- ----------------------------
INSERT INTO `sys_visit_cache` VALUES ('7255147bf46f4a7c815188a86b0477fa', '0:0:0:0:0:0:0:1', 'data_project_path', 'D:\\workspace3\\github\\paladin-boot');
